    ...
    <>
      <div className='container'>
        <div className='row mt-3'>
          ...
          <div className='col-md-4 text-center'> <h1> Movies</h1>  <Link type="button" class="btn btn-success" to="/" >ALL Movies</Link></div>
          <div className='col-md-4'></div>
        </div>
      </div>
      <div className='container'>
        <div className='row'>
          ...
          <div className='col-md-4'>
            ...
            <form action="/action_page.php" className='mt-2' >
             ...
             < Link  to='/' class="btn btn-warning text-center">Submit</ Link >
